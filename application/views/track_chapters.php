<p><?php
	...
	foreach($chapters as $chapter_id => $chapter_row) {
		...
		$a_new_episode = anchor("tracks/index/$track_id", $img_add, "onclick='new_chapter_episode($track_id, $ix); plus_one_html($(\"span[name=num_episodes][track_id=$track_id][ix=$ix]\")); return false;'");
