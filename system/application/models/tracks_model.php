<?php
	...
	class Tracks_Model extends Database_Table {
		...
		public function get_chapters($id, $orderby = 'ix') {
			...
			$this->db->select('chapters.id, chapters.track_id, chapters.ix, chapters.length, chapters.filesize');
			...
			$this->db->group_by('chapters.id, chapters.track_id, chapters.ix, chapters.length, chapters.filesize');
